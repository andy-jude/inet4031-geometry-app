...
def sphereForm():
   if request.method == "POST":
       ...
       if input == "surface_area":
         area = sphere.surfaceArea(int(radius))
         return "User entered: Radius "+ str(radius) + ". <p>The Surface Area is: " + str(area)
